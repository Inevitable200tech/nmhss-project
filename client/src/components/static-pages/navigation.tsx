          ...
          <div className="hidden md:flex items-center space-x-8 relative">
            ...
            >
              ...
              <div className="absolute left-1/2 -translate-x-1/2 top-full mt-3 w-64 pointer-events-none">
                ...
                >
                  <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/30 dark:border-gray-700/50 overflow-hidden">
                    <a href="https://www.google.com" onClick={(e) => { handleLinkClick(e, 'https://www.google.com'); setIsClubOpen(false); }} className="block px-6 py-4 text-foreground hover:bg-white/40 dark:hover:bg-gray-700/40 transition-all font-medium">
                      N.S.S
                    </a>
                  </div>
            ...
            <a href="/about-teachers" className="text-foreground hover:text-primary transition-colors">Teachers</a>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden border-t border-white/20 dark:border-gray-700/20 backdrop-blur-xl bg-white/70 dark:bg-gray-900/70">
            <div className="px-4 py-3 space-y-1">
              ...
              {isClubOpen && (
                <div className="pl-6 space-y-2 bg-white/40 dark:bg-gray-800/40 rounded-xl py-3">
                  <a href="https://instagram.com" onClick={(e) => { handleLinkClick(e, "https://instagram.com"); setIsMobileMenuOpen(false); }} className="block py-2.5 text-foreground hover:text-primary">N.S.S</a>

                </div>
              )}

              <a href="/about-teachers" onClick={(e) => { handleLinkClick(e, "/about-teachers"); setIsMobileMenuOpen(false); }} className="block py-3 text-foreground hover:text-primary"> Teachers</a>
              <a href="/news" onClick={(e) => { handleLinkClick(e, "/news"); setIsMobileMenuOpen(false); }} className="block py-3 text-foreground hover:text-primary">News</a>
