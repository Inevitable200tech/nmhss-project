...
export default function Footer() {
  const quickLinks = [
    { href: "/about-us", label: "About Us", testId: "footer-link-about" },
    { href: "/academic-results", label: "Academics", testId: "footer-link-academics" },
    { href: "#faculty", label: "Faculty", testId: "footer-link-faculty" },
    { href: "#events", label: "Events", testId: "footer-link-events" },
  ];

  const resources = [
    { href: "/students", label: "Student Handbook", testId: "footer-link-handbook" },
    { href: "#calendar", label: "Academic Calendar", testId: "footer-link-calendar" },
    { href: "/academic-results", label: "Exam Results", testId: "footer-link-results" },
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
          ...
          <div data-testid="footer-school-info">
            ...
            <p className="text-sm opacity-80 leading-relaxed mb-4">
              Excellence in education since 1998. Nurturing young minds and building character
              through quality English & Malayalam medium  in a co-educational environment.
            </p>
